...
public class MoviceListPresenter extends DefualtListPresenter {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.xilie_movie_item, parent, false);
...
//        itemView.setTag(tag);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if ("gd".equals(movie.getTag())) {
            Drawable d = viewHolder.view.getResources().getDrawable(R.drawable.gengduo);
